...
\end{wrapfigure}
    ...
    good work balance with low overheads and good scalability. We refactor backjumping to be a
    ``fold with left-zero elements'', to allow parallel search without risking an absolute slowdown.
